"""Generated mapper for `foxglove_msgs/msg/SpherePrimitive`."""
...
def sphere_primitive_to_bus(msg):
    from robot_bus.foxglove_msgs.msg.v1 import SpherePrimitive as BusMsg
...
def sphere_primitive_to_ros(bus):
...
class FoxgloveMsgsSpherePrimitiveMapper:
    ...
    def ros_to_bus(self, msg) -> bytes:
        return sphere_primitive_to_bus(msg).SerializeToString()
    ...
    def bus_to_ros(self, payload: bytes):
        ...
        return sphere_primitive_to_ros(bus)
