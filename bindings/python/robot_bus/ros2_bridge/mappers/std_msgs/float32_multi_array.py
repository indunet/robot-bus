"""Generated mapper for `std_msgs/msg/Float32MultiArray`."""
...
def float32_multi_array_to_bus(msg):
    from robot_bus.std_msgs.msg.v1 import Float32MultiArray as BusMsg
...
def float32_multi_array_to_ros(bus):
    from std_msgs.msg import Float32MultiArray as RosMsg
...
class StdMsgsFloat32MultiArrayMapper:
    ...
    def ros_to_bus(self, msg) -> bytes:
        return float32_multi_array_to_bus(msg).SerializeToString()
    ...
    def bus_to_ros(self, payload: bytes):
        ...
        return float32_multi_array_to_ros(bus)
