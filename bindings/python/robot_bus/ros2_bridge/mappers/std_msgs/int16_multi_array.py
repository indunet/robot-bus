"""Generated mapper for `std_msgs/msg/Int16MultiArray`."""
...
def int16_multi_array_to_bus(msg):
    from robot_bus.std_msgs.msg.v1 import Int16MultiArray as BusMsg
...
def int16_multi_array_to_ros(bus):
    from std_msgs.msg import Int16MultiArray as RosMsg
...
class StdMsgsInt16MultiArrayMapper:
    ...
    def ros_to_bus(self, msg) -> bytes:
        return int16_multi_array_to_bus(msg).SerializeToString()
    ...
    def bus_to_ros(self, payload: bytes):
        ...
        return int16_multi_array_to_ros(bus)
