...
#include <robot_bus/ros2_bridge/mappers/foxglove_msgs/vector2.hpp>
...
#if defined(ROBOT_BUS_HAS_ROS2) && defined(ROBOT_BUS_HAS_FOXGLOVE_MSGS)
inline ::foxglove_msgs::msg::v1::Grid grid_to_bus(const ::foxglove_msgs::msg::Grid &msg) {
  ::foxglove_msgs::msg::v1::Grid bus;
  ...
  *bus.mutable_cell_size() = ::robot_bus::ros2_bridge_mappers::foxglove_msgs::vector2_to_bus(msg.cell_size);
...
inline ::foxglove_msgs::msg::Grid grid_to_ros(const ::foxglove_msgs::msg::v1::Grid &bus) {
  ::foxglove_msgs::msg::Grid out;
  ...
  out.cell_size = ::robot_bus::ros2_bridge_mappers::foxglove_msgs::vector2_to_ros(bus.cell_size());
...
class FoxgloveMsgsGridMapper
    : public TypedTopicMapper<FoxgloveMsgsGridMapper, ::foxglove_msgs::msg::Grid> {
 public:
  const char *type_name() const override { return "foxglove_msgs/msg/Grid"; }

  std::vector<uint8_t> ros_to_bus(const ::foxglove_msgs::msg::Grid &msg) const {
    auto bus = ros2_bridge_mappers::foxglove_msgs::grid_to_bus(msg);
    std::string bytes;
    bus.SerializeToString(&bytes);
    return std::vector<uint8_t>(bytes.begin(), bytes.end());
  }

  ::foxglove_msgs::msg::Grid bus_to_ros(BytesView payload) const {
    ::foxglove_msgs::msg::v1::Grid bus;
    bus.ParseFromArray(payload.data, static_cast<int>(payload.size));
    return ros2_bridge_mappers::foxglove_msgs::grid_to_ros(bus);
  }
};
#else
struct FoxgloveMsgsGridMapper : TopicMapper {
  const char *type_name() const override { return "foxglove_msgs/msg/Grid"; }
};
#endif
