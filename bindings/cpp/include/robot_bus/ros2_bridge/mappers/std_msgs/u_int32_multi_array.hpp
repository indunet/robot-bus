...
#if defined(ROBOT_BUS_HAS_ROS2)
inline ::std_msgs::msg::v1::UInt32MultiArray u_int32_multi_array_to_bus(const ::std_msgs::msg::UInt32MultiArray &msg) {
  ::std_msgs::msg::v1::UInt32MultiArray bus;
...
inline ::std_msgs::msg::UInt32MultiArray u_int32_multi_array_to_ros(const ::std_msgs::msg::v1::UInt32MultiArray &bus) {
  ::std_msgs::msg::UInt32MultiArray out;
...
class StdMsgsUInt32MultiArrayMapper
 ...
 public:
  ...
  ::std_msgs::msg::UInt32MultiArray bus_to_ros(BytesView payload) const {
    ::std_msgs::msg::v1::UInt32MultiArray bus;
    bus.ParseFromArray(payload.data, static_cast<int>(payload.size));
    return ros2_bridge_mappers::std_msgs::u_int32_multi_array_to_ros(bus);
  }
};
#else
