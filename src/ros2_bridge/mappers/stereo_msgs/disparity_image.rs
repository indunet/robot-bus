...
pub(crate) fn disparity_image_to_bus(
    msg: ros_env::stereo_msgs::msg::DisparityImage,
    ...
    crate::stereo_msgs::msg::v1::DisparityImage {
        ...
        t: msg.t,
        valid_window: Some(
            crate::ros2_bridge::mappers::sensor_msgs::region_of_interest::region_of_interest_to_bus(
                msg.valid_window,
            ),
        ),
...
pub(crate) fn disparity_image_to_ros(
    ...
    ros_env::stereo_msgs::msg::DisparityImage {
        ...
        image: crate::ros2_bridge::mappers::sensor_msgs::image::image_to_ros(
            bus.image.unwrap_or_default(),
        ),
        f: bus.f,
        t: bus.t,
        valid_window:
            crate::ros2_bridge::mappers::sensor_msgs::region_of_interest::region_of_interest_to_ros(
                bus.valid_window.unwrap_or_default(),
            ),
