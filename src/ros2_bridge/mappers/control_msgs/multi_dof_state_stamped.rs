...
pub(crate) fn multi_dof_state_stamped_from_view(
    ...
    Ok(crate::control_msgs::msg::v1::MultiDofStateStamped {
        header: nested_view(view, "header")?
            ...
            .transpose()?,
        dof_states: read_message_seq(view, "dof_states", super::single_dof_state::single_dof_state_from_view)?,
    })
}
...
pub(crate) fn multi_dof_state_stamped_write(
    ...
    write_message_seq(view, "dof_states", &bus.dof_states, super::single_dof_state::single_dof_state_write)?;
    Ok(())
}
