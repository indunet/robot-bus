...
pub(crate) fn vector3_stamped_to_bus(
    msg: ros_env::geometry_msgs::msg::Vector3Stamped,
) -> crate::geometry_msgs::msg::v1::Vector3Stamped {
    crate::geometry_msgs::msg::v1::Vector3Stamped {
        header: Some(crate::ros2_bridge::mappers::std_msgs::header::header_to_bus(msg.header)),
        vector: Some(
            crate::ros2_bridge::mappers::geometry_msgs::vector3::vector3_to_bus(msg.vector),
        ),
    }
}

pub(crate) fn vector3_stamped_to_ros(
    ...
    ros_env::geometry_msgs::msg::Vector3Stamped {
        ...
        vector: crate::ros2_bridge::mappers::geometry_msgs::vector3::vector3_to_ros(
            bus.vector.unwrap_or_default(),
        ),
    }
}
