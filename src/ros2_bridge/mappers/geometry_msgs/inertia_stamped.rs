...
pub(crate) fn inertia_stamped_to_bus(
    msg: ros_env::geometry_msgs::msg::InertiaStamped,
) -> crate::geometry_msgs::msg::v1::InertiaStamped {
    crate::geometry_msgs::msg::v1::InertiaStamped {
        header: Some(crate::ros2_bridge::mappers::std_msgs::header::header_to_bus(msg.header)),
        inertia: Some(
            crate::ros2_bridge::mappers::geometry_msgs::inertia::inertia_to_bus(msg.inertia),
        ),
    }
}

pub(crate) fn inertia_stamped_to_ros(
    ...
    ros_env::geometry_msgs::msg::InertiaStamped {
        ...
        inertia: crate::ros2_bridge::mappers::geometry_msgs::inertia::inertia_to_ros(
            bus.inertia.unwrap_or_default(),
        ),
    }
}
