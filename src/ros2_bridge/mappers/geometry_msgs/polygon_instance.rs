...
pub(crate) fn polygon_instance_to_bus(
    msg: ros_env::geometry_msgs::msg::PolygonInstance,
) -> crate::geometry_msgs::msg::v1::PolygonInstance {
    crate::geometry_msgs::msg::v1::PolygonInstance {
        polygon: Some(
            crate::ros2_bridge::mappers::geometry_msgs::polygon::polygon_to_bus(msg.polygon),
        ),
        id: msg.id,
    }
}

pub(crate) fn polygon_instance_to_ros(
    bus: crate::geometry_msgs::msg::v1::PolygonInstance,
) -> ros_env::geometry_msgs::msg::PolygonInstance {
    ros_env::geometry_msgs::msg::PolygonInstance {
        polygon: crate::ros2_bridge::mappers::geometry_msgs::polygon::polygon_to_ros(
