...
pub(crate) fn polygon_instance_stamped_to_bus(
    msg: ros_env::geometry_msgs::msg::PolygonInstanceStamped,
) -> crate::geometry_msgs::msg::v1::PolygonInstanceStamped {
    crate::geometry_msgs::msg::v1::PolygonInstanceStamped {
        header: Some(crate::ros2_bridge::mappers::std_msgs::header::header_to_bus(msg.header)),
        polygon: Some(
            crate::ros2_bridge::mappers::geometry_msgs::polygon_instance::polygon_instance_to_bus(
                msg.polygon,
            ),
        ),
    }
...
pub(crate) fn polygon_instance_stamped_to_ros(
    ...
    ros_env::geometry_msgs::msg::PolygonInstanceStamped {
        ...
        polygon:
            crate::ros2_bridge::mappers::geometry_msgs::polygon_instance::polygon_instance_to_ros(
                bus.polygon.unwrap_or_default(),
            ),
    }
}
