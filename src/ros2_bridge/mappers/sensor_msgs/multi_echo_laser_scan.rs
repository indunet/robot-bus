...
pub(crate) fn multi_echo_laser_scan_to_bus(
    msg: ros_env::sensor_msgs::msg::MultiEchoLaserScan,
    ...
    crate::sensor_msgs::msg::v1::MultiEchoLaserScan {
        ...
        ranges: msg
            .ranges
            .into_iter()
            .map(crate::ros2_bridge::mappers::sensor_msgs::laser_echo::laser_echo_to_bus)
            .collect(),
        intensities: msg
            .intensities
            .into_iter()
...
pub(crate) fn multi_echo_laser_scan_to_ros(
    ...
    ros_env::sensor_msgs::msg::MultiEchoLaserScan {
        ...
        ranges: bus
            .ranges
            .into_iter()
            .map(crate::ros2_bridge::mappers::sensor_msgs::laser_echo::laser_echo_to_ros)
            .collect(),
        intensities: bus
            .intensities
            .into_iter()
