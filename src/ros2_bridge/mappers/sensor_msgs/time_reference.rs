...
pub(crate) fn time_reference_to_bus(
    msg: ros_env::sensor_msgs::msg::TimeReference,
) -> crate::sensor_msgs::msg::v1::TimeReference {
    crate::sensor_msgs::msg::v1::TimeReference {
        header: Some(crate::ros2_bridge::mappers::std_msgs::header::header_to_bus(msg.header)),
        time_ref: Some(
            crate::ros2_bridge::mappers::builtin_interfaces::time::time_to_bus(msg.time_ref),
        ),
        source: crate::ros2_bridge::mappers::convert::from_ros_string(msg.source),
    }
}

pub(crate) fn time_reference_to_ros(
    ...
    ros_env::sensor_msgs::msg::TimeReference {
        ...
        time_ref: crate::ros2_bridge::mappers::builtin_interfaces::time::time_to_ros(
            bus.time_ref.unwrap_or_default(),
        ),
