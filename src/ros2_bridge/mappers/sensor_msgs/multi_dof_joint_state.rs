...
pub(crate) fn multi_dof_joint_state_to_bus(
    msg: ros_env::sensor_msgs::msg::MultiDOFJointState,
    ...
    crate::sensor_msgs::msg::v1::MultiDofJointState {
        ...
        wrench: msg
            .wrench
            .into_iter()
            .map(crate::ros2_bridge::mappers::geometry_msgs::wrench::wrench_to_bus)
            .collect(),
    }
}

pub(crate) fn multi_dof_joint_state_to_ros(
    ...
    ros_env::sensor_msgs::msg::MultiDOFJointState {
        ...
        wrench: bus
            .wrench
            .into_iter()
            .map(crate::ros2_bridge::mappers::geometry_msgs::wrench::wrench_to_ros)
            .collect(),
    }
}
