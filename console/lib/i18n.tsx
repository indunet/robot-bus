...
const en = {
  ...
  navBotSim: 'BOT VIEWER',
  navBotSimShort: 'BOT',
  navBotWindows: 'OPEN BOT VIEWER + CONTROL PANEL',
  botSimWindowTitle: 'BOT SIM VIEWER · bot_sim_viewer',
  botTeleopWindowTitle: 'BOT CONTROL PANEL · bot_control_panel',
  botPoseTitle: 'POSE',
  ...
  botPublish: 'PUB',
  botSubscribe: 'SUB',
  botViewerHint: 'Render only — run: cargo run --example bot_sim',
...
const zh: Record<MessageKey, string> = {
  ...
  navBotSim: '小机器人视图',
  navBotSimShort: 'BOT',
  navBotWindows: '打开小机器人视图与控制面板',
  botSimWindowTitle: '小机器人视图 · bot_sim_viewer',
  botTeleopWindowTitle: '小机器人控制面板 · bot_control_panel',
  botPoseTitle: '位姿',
  botTeleopTitle: '控制',
  botConnecting: '连接中',
  botOnline: '在线',
  ...
  botPublish: '发布',
  botSubscribe: '订阅',
  botViewerHint: '仅渲染 — 请运行：cargo run --example bot_sim',
