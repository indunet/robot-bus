...
const en = {
  ...
  flowTitle: 'FLOW',
  flowSub: '{n} plumbing nodes · {e} wires',
  flowHint:
    'Edit config-driven plumbing (rbus_* + ROS 2 bridge). Connect ports to wire topics. Live/missing vs Topology; external processes are read-only ghosts. Export YAML — does not start processes.',
  flowImport: 'Import',
  flowPaste: 'Paste YAML',
  flowApplyPaste: 'Apply paste',
  flowExport: 'Export',
  flowCopy: 'Copy',
  flowExample: 'Load example',
  flowRemove: 'Delete',
  flowToggleYaml: 'YAML',
  flowLaunch: 'Launch cmds',
  flowBroker: 'Broker',
  flowPalette: 'Palette',
  flowInspector: 'Node',
  flowEditEdge: 'Wire',
  flowFieldName: 'Node name',
  flowFieldTopic: 'Topic',
  flowImported: 'Flow imported',
  flowUpgraded: 'Legacy bridge YAML upgraded to flow',
  flowExported: 'flow.yaml downloaded',
  flowCopied: 'Copied to clipboard',
  flowCopyFailed: 'Clipboard copy failed',
  flowExampleLoaded: 'Example loaded',
  flowLaunchCopied: 'Launch commands copied',
  flowExportParams: 'Export params YAML',
  flowParamsExported: 'Params YAML downloaded',
  flowExportBridge: 'Export bridge YAML',
  flowBridgeExported: 'Bridge YAML downloaded',
...
const zh: Record<MessageKey, string> = {
  ...
  flowSub: '{n} 管道节点 · {e} 连线',
  flowHint:
    '编排配置驱动的管道（rbus_* 与 ROS 2 桥）。端口连线即 topic。对照 Topology 显示 live/missing；外部业务进程为只读 ghost。导出 YAML，不会自动启停进程。',
  flowImport: '导入',
  flowPaste: '粘贴 YAML',
  flowApplyPaste: '应用粘贴',
  flowExport: '导出',
  ...
  flowFieldName: '节点名',
  flowFieldTopic: '话题',
  flowImported: '已导入 Flow',
  flowUpgraded: '已将旧 bridge YAML 升格为 Flow',
  flowExported: '已下载 flow.yaml',
  flowCopied: '已复制到剪贴板',
  flowCopyFailed: '复制失败',
  flowExampleLoaded: '已加载示例',
  flowLaunchCopied: '已复制启动命令',
  flowExportParams: '导出 params YAML',
  flowParamsExported: '已下载 params YAML',
  flowExportBridge: '导出 bridge YAML',
  flowBridgeExported: '已下载 bridge YAML',
