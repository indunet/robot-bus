...
| ws / grpc gateway | Client: pub/sub + call service/action; **cannot** be service/action server |
...
- WS/gRPC Node: can publish/subscribe/call; cannot host service/action servers.
