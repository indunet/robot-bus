...
sudo apt install ./robot-bus_0.1.6_linux_amd64.deb

# Or ROS 2 bridge variant (Humble example) — needs Humble already installed
sudo apt install ./robot-bus-ros2-humble_0.1.6_linux_amd64.deb
source /opt/ros/humble/setup.bash

# macOS Apple Silicon (core package only)
sudo installer -pkg robot-bus_0.1.6_macos_arm64.pkg -target /
