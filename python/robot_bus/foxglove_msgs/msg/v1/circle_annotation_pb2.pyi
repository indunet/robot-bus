...
class CircleAnnotation(_message.Message):
    ...
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., position: _Optional[_Union[_point2_pb2.Point2, _Mapping]] = ..., diameter: _Optional[float] = ..., thickness: _Optional[float] = ..., fill_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., outline_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., metadata: _Optional[_Iterable[_Union[_key_value_pair_pb2.KeyValuePair, _Mapping]]] = ...) -> None: ...
