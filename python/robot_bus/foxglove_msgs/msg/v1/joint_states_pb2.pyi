...
class JointStates(_message.Message):
    ...
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., joints: _Optional[_Iterable[_Union[_joint_state_pb2.JointState, _Mapping]]] = ...) -> None: ...
