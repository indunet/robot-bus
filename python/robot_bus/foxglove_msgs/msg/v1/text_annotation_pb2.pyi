...
class TextAnnotation(_message.Message):
    ...
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., position: _Optional[_Union[_point2_pb2.Point2, _Mapping]] = ..., text: _Optional[str] = ..., font_size: _Optional[float] = ..., text_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., background_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., metadata: _Optional[_Iterable[_Union[_key_value_pair_pb2.KeyValuePair, _Mapping]]] = ...) -> None: ...
