...
- Message HWM=2048（仅 bench）；与 trial长度配合，避免深队列把过载藏掉。
- 指标为单机本机回环，机器相关，不作为 CI门槛。
- 与 ROS2对比见 [`../ros2_perf/`](../ros2_perf/) / [`docs/zh/ros2-perf-report.md`](../../docs/zh/ros2-perf-report.md)；注意 macOS本机 vs Linux容器环境差异。
